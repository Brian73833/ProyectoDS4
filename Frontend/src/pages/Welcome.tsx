...
const IMG_WELCOME_HERO = "/src/assets/auth-hero.png";
const IMG_WELCOME_TEXTURE = "/src/assets/auth-hero.png";
const IMG_WELCOME_INTERIOR = "/src/assets/auth-hero.png";
...
const StatBadge: React.FC<StatBadgeProps> = ({ icon, label, value }) => (
  <div className="bg-stone-50 border border-slate-300 p-6 flex items-center gap-4">
    <span
      className="material-symbols-outlined text-[#E2725B]"
      style={ICON_STYLE}
    >
      {icon}
    </span>
    <div>
      <div className="font-label-caps text-[10px] text-stone-500 uppercase tracking-widest">
        {label}
      </div>
      <div className="font-headline-md text-stone-900 font-bold">{value}</div>
    </div>
  </div>
);
...
const Welcome: React.FC = () => {
  ...
  return (
    <main className="flex-grow bg-background font-body-md text-on-background">
      <section className="relative w-full min-h-[420px] sm:min-h-[560px] md:h-[650px] overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col justify-center items-start px-4 sm:px-8 md:px-16 py-12 md:py-0 md:absolute md:inset-0">
          <div className="w-full bg-white/95 p-5 sm:p-10 md:p-16 border-l-[6px] sm:border-l-[12px] border-[#E2725B]">
            <p className="font-label-caps text-xs text-[#E2725B] mb-3 uppercase tracking-widest">
              ESTABLISHED 1924
            </p>
            <h2 className="font-headline-xl text-2xl sm:text-4xl md:text-5xl text-stone-900 mb-4 sm:mb-6 uppercase leading-tight font-extrabold">
              Architectural Excellence in Every Kiln-Fired Unit.
            </h2>
            <p className="font-body-lg text-sm sm:text-base md:text-lg text-stone-500 mb-6 sm:mb-12 max-w-2xl">
            ...
            <div className="flex gap-4 sm:gap-6">
              <button
                ...
                className="bg-[#E2725B] text-white font-bold text-xs uppercase tracking-widest px-6 sm:px-12 py-4 sm:py-6 hover:bg-[#c95d47] transition-all active:translate-y-0.5 border-b-4 border-stone-900 cursor-pointer"
              >
                ENTER STORE
              </button>
            </div>
      ...
      <section className="py-10 sm:py-16 md:py-20 px-4 sm:px-8 md:px-16 max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          <div className="md:col-span-8 bg-stone-100 border border-slate-300 p-6 sm:p-10 md:p-12 flex flex-col justify-between min-h-[280px] sm:min-h-[340px] md:min-h-[400px]">
            <div>
              <span
                className="material-symbols-outlined text-[#E2725B] mb-3 block"
                style={{ fontSize: 48, ...ICON_STYLE }}
              >
                texture
              </span>
              <h3 className="font-headline-lg text-xl sm:text-2xl font-extrabold text-stone-900 mb-2 uppercase">
                Granular Detail
              </h3>
              <p className="font-body-md text-stone-500 max-w-md">
            ...
            <div className="mt-8 sm:mt-12">
              <img
                alt="Texture Detail"
                className="w-full h-40 sm:h-48 object-cover border-b-4 border-[#E2725B]"
          ...
          <div className="md:col-span-4 bg-stone-900 text-stone-100 border border-slate-700 p-8 sm:p-12 flex flex-col justify-center items-center text-center">
            <span
              className="material-symbols-outlined text-[#E2725B] mb-6 block"
              style={{ fontSize: 64, ...ICON_STYLE }}
            >
              precision_manufacturing
            </span>
            <h3 className="font-headline-md text-xl font-bold uppercase mb-2">
            ...
            <hr className="w-16 border-[#E2725B] border-2 mb-8 sm:mb-12" />
            <div className="font-label-caps text-xs uppercase tracking-widest text-stone-300">
              CERTIFIED ASTM C216
            </div>
          </div>
          ...
          <div className="col-span-1 md:col-span-12 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mt-2 sm:mt-6">
            ...
            <StatBadge icon="public" label="GLOBAL REACH" value="50 Countries" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-stone-50 py-10 sm:py-16 md:py-20 px-4 sm:px-8 md:px-16 border-y border-slate-200">
        <div className="flex flex-col md:flex-row items-center gap-8 sm:gap-12 md:gap-20">
          ...
          <div className="w-full md:w-1/2">
            <h2 className="font-headline-xl text-3xl font-extrabold text-stone-900 mb-6 uppercase">
              Material Honesty
            </h2>
            <p className="font-body-lg text-lg text-stone-500 mb-12">
